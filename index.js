...
getSwitchBtn[2].addEventListener('click', function () {
    ...
    document.getElementById("arrowPurple").style.display = "none",
        getPlayIconCon.style.backgroundColor = "#f8eded";
...
window.onload = function() {
    ...
    setInterval(function() {
      document.getElementById("counDownOne").innerHTML = customer ;
      document.getElementById("counDownTwo").innerHTML = Product ;
      document.getElementById("counDownThree").innerHTML =Owned ;
